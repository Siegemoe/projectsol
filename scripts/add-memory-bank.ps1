# Adds memory-bank-mcp server to existing clean cline_mcp_settings.json
...
# Create complete configuration adding memory-bank-mcp
$updatedJson = @'
{
  "mcpServers": {
...
Write-Host "Memory Bank MCP server added to configuration."
Write-Host "Memory bank root set to: C:\Users\zghor\Documents\Cline\MemoryBank"
